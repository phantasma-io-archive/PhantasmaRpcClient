    ...
    public class BlockApi : IBlockApi
    {
        ...
        public BlockResult GetBlockByHash(string blockHash)
        {
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException((int)response.StatusCode, "Error calling GetBlockByHashGet: " + response.Content,
                    response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException((int)response.StatusCode,
                    "Error calling GetBlockByHashGet: " + response.ErrorMessage, response.ErrorMessage);
        ...
        public BlockResult GetBlockByHeight(string chainInput, int? height)
        {
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException((int)response.StatusCode,
                    "Error calling GetBlockByHeightGet: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException((int)response.StatusCode,
                    "Error calling GetBlockByHeightGet: " + response.ErrorMessage, response.ErrorMessage);
        ...
        public string GetBlockHeight(string chainInput)
        {
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException((int)response.StatusCode, "Error calling GetBlockHeightGet: " + response.Content,
                    response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException((int)response.StatusCode,
                    "Error calling GetBlockHeightGet: " + response.ErrorMessage, response.ErrorMessage);
        ...
        public int? GetBlockTransactionCountByHash(string chainAddressOrName, string blockHash)
        {
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException((int)response.StatusCode,
                    "Error calling GetBlockTransactionCountByHashGet: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException((int)response.StatusCode,
                    "Error calling GetBlockTransactionCountByHashGet: " + response.ErrorMessage, response.ErrorMessage);
        ...
        public string GetRawBlockByHash(string blockHash)
        {
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException((int)response.StatusCode,
                    "Error calling GetRawBlockByHashGet: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException((int)response.StatusCode,
                    "Error calling GetRawBlockByHashGet: " + response.ErrorMessage, response.ErrorMessage);
        ...
        public string GetRawBlockByHeight(string chainInput, int? height)
        {
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException((int)response.StatusCode,
                    "Error calling GetRawBlockByHeightGet: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException((int)response.StatusCode,
                    "Error calling GetRawBlockByHeightGet: " + response.ErrorMessage, response.ErrorMessage);
